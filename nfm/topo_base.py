...
from ryu.ofproto import (nx_match, ofproto_v1_0, ofproto_v1_2, ofproto_v1_3,
                         ofproto_v1_4)
from ryu.ofproto.ether import ETH_TYPE_CFM, ETH_TYPE_LLDP
...
class Switches(app_manager.RyuApp):
    ...
    @set_ev_cls(event.EventHaltLLDP)
    def halt_handler(self, ev):
        print('close myself')
        self.is_alive = False
